...
export default function (){
    const {apiURL, setLoading,favorite, AddtoFav,setError, loading} = useContext(AppContext) // global variable
...
const isFavorite = favorite.some((fav) => fav.id === bookDetail.id);
   ...
   <div style={{display:"flex", height:"80vh", justifyContent:"center", alignItems:"center"}}>
    ...
    <div style={{display:"flex", width:"30%" ,padding:"10px", justifyContent:"center", alignItems:"center", flexDirection:"column"
    }}>
        
        <img style={{display:"inline-block", height:"360px"}} src={bookDetail.formats["image/jpeg"]} alt="" />
...
<h3 style={{padding:"4px"}}>{bookDetail.title}</h3>
        <p style={{color:"red",marginBottom:"33px"}}> by {bookDetail.authors?.[0].name}</p>
